    ...
    return(
        ...
        <div>
            ...
            <div className=" flex flex-row flex-wrap mb-20">
                ...
                <div>
                    <img src={Group} alt='Healling' className=" w-96 mt-16 ml-96 h-80 "/>
                </div>
            </div>
            <div className="flex flex-row flex-wrap  mb-20">
                <div className=" w-3/4 ml-20  ">
                     <h5 className=" -mb-2">Full Name:  </h5><br/> 
                     <input type="Name" id="Name" name="Name"  placeholder="Enter your full name here..." className="shadow p-3 mb-5 bg-white rounded w-1/3 h-20"/> <br/>
                     <h5 className=" -mb-2 -mt-2">Email:   </h5><br/>
                     <input type="Email" id="Email" name="Email"  placeholder="Enter your email address here..." className="shadow p-3 mb-5 bg-white rounded h-20 w-1/3"/> <br/>
                     <h5 className=" -mb-2 -mt-2">Details:  </h5><br/>
                     <textarea id="Details" name="Details" placeholder="Enter your details here..." className="shadow p-3 mb-5 bg-white rounded  w-1/3 h-44"/> <br/>
                     <button type="submit" className="btn btn btn-info bg-[#2DD3E3] -mt-8 w-56">Submit</button>
                </div>
                <div className=" d-table-cell mt-44 -ml-96 ">
                    <div className="card w-96  h-52 bg-[#EAF8F9] border border-0" >
